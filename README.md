...
- Основа режима «игрок-хост»: подключение по IP и общий seed, время и погода.
...
Сетевой прототип пока не синхронизирует юнитов и приказы: этот слой будет
подключён после замены тестового управления. Подробнее: [NETWORK_NOTES.md](NETWORK_NOTES.md).
