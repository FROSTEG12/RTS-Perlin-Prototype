...
«Создать» автоматически запускает сервер отдельным процессом без графики.
Оба игрока видят движение своего и чужого юнита; сервер рассчитывает маршруты,
время и погоду независимо от фокуса игровых окон. «Войти» подключает к этому серверу.
Подробнее:
