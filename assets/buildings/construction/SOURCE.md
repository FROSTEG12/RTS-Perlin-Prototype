...
Only one stage is visible. The completed model determines the common origin;
all five stages share scale 0.6. Original source layout is preserved.
Placement still creates completed buildings. BuildingSite.set_construction_stage
supports stages 1..5 for future construction logic; no timers or costs added.
